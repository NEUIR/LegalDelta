...
class _UnslothGRPOTrainer(Trainer):
    ...
    def extract_answer_tokens_and_probs(self, completion_ids, completion_logits, completions_text):
        ...
        for batch_idx in range(completion_ids.shape[0]):
            try:
                ...
                content_end_idx = eoa_positions[0] 
    ...
    @profiling_decorator
    def _calculate_rewards(self, inputs, prompts, completions, completion_ids_list, answer_token_info, baseline_answer_info):
        device = self.accelerator.device
    ...
    def _generate_and_score_completions(
        ...
        rewards_per_func = self._calculate_rewards(inputs, original_prompts, completions, completion_ids_list, answer_token_info, baseline_answer_info)
